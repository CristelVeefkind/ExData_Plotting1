...
#create the histogramg and save it to plot2.png
png(file = "plot2.png", bg = "transparent", width= 768, height= 768)
plot(df_house_2$DateTime,df_house_2$Global_active_power,type = "l",ylab="Global Active Power(kilowatts)",xlab = "")
dev.off()
